...
var UserService = (function () {
    function UserService(http) {
        this.http = http;
        this.serviceUrl = "https://resolve-rest.herokuapp.com/users";
    }
    ...
    UserService.prototype.update = function (user) {
        ...
        var options = new http_1.RequestOptions({ headers: headers });
        var body = JSON.stringify(user);
        return this.http.patch(this.serviceUrl, body, options).map(function (res) { return res.text(); });
    };
    UserService.prototype.delete = function (username) {
        var url = this.serviceUrl + '/' + username;
